...
- **Honesty.** The old showcase never disclosed that its four products were concept work, not real or shipped. The portfolio's own stated principle is "never invent information, never exaggerate," so silently restoring four unlabeled fake companies as a "project" doesn't meet that bar. Craft fixes this by labeling concept work as concept work, explicitly and without apology.
